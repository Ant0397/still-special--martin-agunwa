    ...
    return (
        <div className={`carousel__block carousel__block--${theme}`}>
            ...
            <div className="carousel__strip">
                <AutoCarousel theme={theme} contentCardItems={blogs} contentCardType="image" /> 
                <ContentCard theme={theme} carouselStrip="carousel" type="video" title={videos.filter(video => video.title == 'Still Special - Visualised Audio')[0].title} content={videos.filter(video => video.title == 'Still Special - Visualised Audio')[0]} />
                <AutoCarousel theme={theme} contentCardItems={carouselImages} contentCardType="image" />
            </div>
        </div>
    )
}