    ...
    return (
        <Switch>
            ...
            <Route exact path={match.url + '/3'}>
                <Article title={articles[2].title}>
            ...
            <Route exact path={match.url + '/4'}>
                <Article title={articles[3].title}>
            ...
            <Route exact path={match.url + '/5'}>
                <Article title={articles[4].title}>
            ...
            <Route exact path={match.url + '/6'}>
                <Article title={articles[5].title}>
            ...
            <Route exact path={match.url + '/7'}>
                <Article title={articles[6].title}>
            ...
            <Route exact path={match.url + '/8'}>
                <Article title={articles[7].title}>
